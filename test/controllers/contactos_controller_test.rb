...
class ContactosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contacto" do
    assert_difference("Contacto.count") do
      post contactos_url, params: { contacto: { email: @contacto.email, mensaje: @contacto.mensaje, nombre: @contacto.nombre, telefono: @contacto.telefono } }
    end
  ...
  test "should update contacto" do
    patch contacto_url(@contacto), params: { contacto: { email: @contacto.email, mensaje: @contacto.mensaje, nombre: @contacto.nombre, telefono: @contacto.telefono } }
